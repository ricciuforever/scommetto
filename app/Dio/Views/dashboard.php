...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div
            ...
            <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest block mb-1">ROI Atteso</span>
            <div class="text-xl font-black text-indigo-400"><?php echo number_format($stats['roi'], 2); ?>%</div>
        </div>
    </div>

    <!-- 3. Recent Bets (Ultime Operazioni Quantum) -->
    ...
    <!-- 5. Analisi Autonoma (Thinking Logs) & Performance Chart -->
    ...
    <!-- 6. RAG Brain Memory (Experiences) -->
    <div class="bg-white/5 rounded-2xl border border-white/10 glass overflow-hidden">
