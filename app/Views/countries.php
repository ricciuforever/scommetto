<?php
// app/Views/countries.php
$pageTitle = 'Scommetto.AI - Database Nazioni';
    ...
    function App() {
        ...
        useEffect(() => {
            fetch('/api/countries')
                ...
                .catch(err => {
                    console.error('Errore nel recupero nazioni:', err);
                    setLoading(false);
                });
        }, []);
            ...
            <div className="max-w-7xl mx-auto">
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-20 gap-4">
                        ...
                        <span className="text-xs font-black uppercase tracking-widest text-slate-500">Sincronizzazione nazioni...</span>
                    </div>
                ) : (
                ...
                {!loading && filteredCountries.length === 0 && (
                    <div className="text-center py-20">
                        <p className="text-slate-500 italic">Nessun risultato trovato per "{search}"</p>
                    </div>
                )}
            </div>
        );
