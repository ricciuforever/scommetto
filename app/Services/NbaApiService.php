<?php
// app/Services/NbaApiService.php
...
class NbaApiService
{
    ...
    public function __construct()
    {
        ...
        $this->baseUrl = Config::NBA_API_BASE_URL;
    }
    ...
    {
        // NBA API v2 uses conference or division usually
    ...
    public function fetchStatistics($gameId)
    {
        return $this->request("/games/statistics?id=$gameId");
    }
    ...
    public function request($endpoint)
    {
        ...
        try {
            ...
            error_log("Usage Tracking Error (NBA): " . $e->getMessage());
        }
