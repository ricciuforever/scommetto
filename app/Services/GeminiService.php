        ...
        if (isset($options['raw_prompt'])) {
            ...
            if ($isUpcoming) {
                ...
                $prompt = "Sei un ANALISTA ELITE e TRADER di Betfair. Il tuo compito è analizzare un EVENTO LIVE con i suoi molteplici mercati e decidere l'operazione migliore.\n\n" .
                    ...
                    "4. Analizza quote Back/Lay, volumi (totalMatched) e DATI STATISTICI LIVE. Per il Basket guarda attentamente a tiri totali, rimbalzi, assist e percentuali dal campo se forniti.\n" .
                    ...
                    "10. ⚠️ NO DATA = NO BET (RELAXED): Se i dati statistici live dettagliati (statistics) mancano, ma hai comunque lo SCORE e il MINUTO del match (tramite api_football.live o fallback Betfair), puoi scommettere SOLO SE la tua confidence è >= 90%. Se manca anche lo score, imposta 'confidence' a 0 e 'advice' a 'NO_LIVE_DATA'.\n" .
