    ...
    <div class="bg-slate-900 w-full max-w-2xl rounded-[40px] border border-white/10 shadow-2xl overflow-hidden relative"
        ...
        <div class="p-10">
            <div class="flex items-center gap-3 mb-8">
                ...
                <div>
                    <h3 class="text-3xl font-black tracking-tight text-white uppercase italic leading-none">AI <span class="text-indigo-400">Predictions</span></h3>
                    <p class="text-slate-500 text-[9px] font-black uppercase tracking-widest mt-1">Crystal Ball Statistical Analysis</p>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="glass p-6 rounded-3xl border-white/5 flex items-center justify-between">
                    <div class="flex-1 text-center">
                        ...
                        <div class="text-lg font-black text-white truncate"><?php echo $details['teams']['home']['name'] ?? 'Home'; ?></div>
                    </div>
                    ...
                    <div class="flex-1 text-center">
                        ...
                        <div class="text-lg font-black text-white truncate"><?php echo $details['teams']['away']['name'] ?? 'Away'; ?></div>
                    </div>
                </div>
                ...
                <div class="glass p-6 rounded-3xl border-white/5">
                    ...
                    <div class="flex h-3 w-full bg-white/5 rounded-full overflow-hidden border border-white/5 mb-3">
                        <div class="bg-accent h-full" style="width: <?php echo $prediction['percent']['home']; ?>" title="Home: <?php echo $prediction['percent']['home']; ?>"></div>
                        <div class="bg-white/20 h-full" style="width: <?php echo $prediction['percent']['draw']; ?>" title="Draw: <?php echo $prediction['percent']['draw']; ?>"></div>
                        <div class="bg-danger h-full" style="width: <?php echo $prediction['percent']['away']; ?>" title="Away: <?php echo $prediction['percent']['away']; ?>"></div>
                    </div>
                    <div class="flex justify-between text-[10px] font-black uppercase tracking-tighter">
                        <div class="flex flex-col">
                            <span class="text-slate-500">Home</span>
                            <span class="text-accent text-lg"><?php echo $prediction['percent']['home']; ?></span>
                        </div>
                        <div class="flex flex-col text-center">
                            <span class="text-slate-500">Draw</span>
                            <span class="text-slate-300 text-lg"><?php echo $prediction['percent']['draw']; ?></span>
                        </div>
                        <div class="flex flex-col text-right">
                            <span class="text-slate-500">Away</span>
                            <span class="text-danger text-lg"><?php echo $prediction['percent']['away']; ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-indigo-500/10 border border-indigo-500/20 p-6 rounded-3xl">
                        <span class="text-[10px] font-black text-indigo-400 uppercase tracking-widest block mb-2">Advice</span>
                        <p class="text-sm font-black text-white leading-tight italic">
                            "<?php echo $prediction['advice']; ?>"
                        </p>
                    </div>
                    <div class="glass p-6 rounded-3xl border-white/5">
                        <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-1">Under / Over</span>
                        <div class="text-2xl font-black text-white"><?php echo $prediction['under_over']; ?></div>
                    </div>
                </div>
                ...
                <div class="glass p-6 rounded-3xl border-white/5">
                    ...
                    <div class="space-y-3">
                        ...
                        foreach($stats as $label => $key):
                            $hVal = (float)$comparison[$key]['home'];
                            $aVal = (float)$comparison[$key]['away'];
                            $sum = $hVal + $aVal;
                        ...
                        <div class="flex flex-col gap-1">
                            <div class="flex justify-between text-[8px] font-black uppercase text-slate-500 tracking-widest">
                                <span><?php echo $comparison[$key]['home']; ?></span>
                                <span><?php echo $label; ?></span>
                                <span><?php echo $comparison[$key]['away']; ?></span>
                            </div>
