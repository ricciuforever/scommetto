...
<?php else: ?>
    ...
    <div class="animate-fade-in space-y-3 px-2">
            ...
            foreach ($allMatches as $m):
                    $marketId = $m['marketId'];
                    ?>
                    <div class="glass p-4 rounded-[24px] border border-white/5 hover:border-accent/20 transition-all group flex items-center gap-6">
                        ...
                        <!-- Action Section -->
                        <div class="flex items-center gap-6 min-w-[240px] border-l border-white/5 pl-6">
                            <div class="flex flex-col">
                                ...
                                <span class="text-[8px] font-black uppercase text-slate-500 opacity-50 mt-1"><?php echo $m['marketId']; ?></span>
                            </div>
                            ...
                            <button hx-get="/api/gianik/analyze?marketId=<?php echo $marketId; ?>"
                                ...
                                class="px-6 py-3 bg-accent/10 hover:bg-accent/20 text-accent rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 relative border border-accent/10">
